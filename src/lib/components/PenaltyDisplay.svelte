<script lang="ts">
    ...
    const href=`/locks/${lockID}/extensions/${individualPenaltyData.extensionData._id}`;
...
<div class="card-content w-[32em] flex flex-col space-y-[0.5em]">
    ...
    <div class="flex flex-row items-start text-sm whitespace-pre-wrap space-x-[1em]">
        <div class="flex flex-col grow">
            ...
            {#if individualPenaltyData.penaltyConfig.effects.length > 0}
                <ul class="flex flex-col effect-list caption pl-[0.25em] mt-[0.125em]">
